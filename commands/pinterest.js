    ...
    execute: async (api, event, args) => {
        ...
        if (!input) {
            ...
            try {
                ...
                let file = [];
                for (let i = 0; i < len; i++) {
                    const path = `${timestamp}_${i + 1}.jpg`;
                ...
                await api.sendMessage({
                    ...
                    if (err) {
                        ...
                        for (let i = 0; i < len; i++) {
                            fs.unlinkSync(`${timestamp}_${i + 1}.jpg`);
                        }
                    }
                }, event.messageID);
            } catch (error) {
